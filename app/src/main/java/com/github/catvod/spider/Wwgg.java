...
public class Wwgg extends Ali {
    ...
    private final String siteUrl = "http://m.kxys.site:3328/";
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) {
        ...
        Document doc = Jsoup.parse(OkHttp.string(String.format("%s/index.php/vod/show/id/%s.html", siteUrl, String.join("-", urlParams)), getHeader()));
    ...
    private String searchContent(String key, String pg) {
        String searchURL = siteUrl + String.format("/index.php/vod/search/wd/%s.html", URLEncoder.encode(key), pg);
